...
`THE LISTCDS COMMAND DISPLAYS INFORMATION FROM THE SMP CDS DATA SET.`


:warning: requires `MACLIBS` be installed first: Use TSO commands `INSTALL MACLIBS` :warning:
...
```
LISTCDS
 CDS SYSTEM ENTRY - PEMAX=9999   SREL=Z038  NUCID=2  CDSID=MVS
```
