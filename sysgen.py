...
def main():
    ...
    arg_parser.add_argument("--no-compress", help="Do not compress DASD images", default=False)
    ...
    arg_parser.add_argument("--keep-temp", help="Keep backup folder when sysgen completes", action="store_true")
