...
echo_step "Starting Hercules: hercules -f conf/ibcdmprs.cnf -r ../rc/01_sysgen_starter.rc -d"
echo_step "Log file: sysgen.build_starter.$date_time.log"
hercules -f conf/ibcdmprs.cnf -r ../rc/01_sysgen_starter.rc > sysgen.build_starter.$date_time.log
